...
std::array<Input::KeyState, 20> Input::keyboard;
...
void Input::processKeyboardInput(uint32_t keycode, bool isDown, bool wasKeyDown)
{
	...
	case 'N':
		...
		break;
	case 'M':
		keyboard[Input::KeyboardButtons::M].isDown = isDown;
		keyboard[Input::KeyboardButtons::M].wasDown = wasKeyDown;
		break;
	case 'G':
		keyboard[Input::KeyboardButtons::G].isDown = isDown;
		keyboard[Input::KeyboardButtons::G].wasDown = wasKeyDown;
		break;
	case VK_CONTROL:
	...
	case 'F':
		...
		break;
	case VK_DELETE:
		keyboard[Input::KeyboardButtons::DEL].isDown = isDown;
		keyboard[Input::KeyboardButtons::DEL].wasDown = wasKeyDown;
		break;
	default:
		break;
	}
